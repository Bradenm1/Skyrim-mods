...
Scriptname TIF__05267AD2 Extends TopicInfo Hidden
...
Form actorBaseRace = firstForm.GetRace() as Form

debug.messagebox(actorBaseRace)

CheatRoomCheatMenuDialogue.StoreForm(actorBaseRace.GetFormID())
;END CODE
EndFunction
;END FRAGMENT
